...
namespace DatabaseTask.Data.Migrations
{
    ...
    [Migration("20251031131109_init1")]
    partial class init1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MaaratudRavimidRavikulastus", b =>
                {
                    b.Property<Guid>("MaaratudRavimidsId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("RavikulastusId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("MaaratudRavimidsId", "RavikulastusId");

                    b.HasIndex("RavikulastusId");

                    b.ToTable("MaaratudRavimidRavikulastus");
                });
            ...
            modelBuilder.Entity("MaaratudRavimidRavikulastus", b =>
                {
                    b.HasOne("DatabaseTask.Core.Domain.MaaratudRavimid", null)
                        .WithMany()
                        .HasForeignKey("MaaratudRavimidsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DatabaseTask.Core.Domain.Ravikulastus", null)
                        .WithMany()
                        .HasForeignKey("RavikulastusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
